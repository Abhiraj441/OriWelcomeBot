...
client.on('guildMemberAdd', member => {
    const channel = member.guild.channels.find(ch => ch.name === 'embed-test') 
// Change 'Channel-Name' to whatever channel you want the welcome message to be in! For this video i will set it as the channel i am having the discord bot in.
